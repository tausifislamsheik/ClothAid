        ...
        <div className="p-5">
                   ...
                   <form onSubmit={handleSubmit}>
                       <fieldset className="fieldset space-y-3">
                        ...
                        <input type="text" name="name" value={formData.name} onChange={handleChange} className="input w-full" placeholder="Enter your full name" />
                        <label className="label text-lg text-gray-500 font-semibold">Email Address</label>
                        <input type="email" name="email" value={formData.email} onChange={handleChange} className="input w-full" placeholder="email@example.com" />
                        <label className="label text-lg text-gray-500 font-semibold">Phone Number</label>
                        <input type="text" name="number" value={formData.number} onChange={handleChange} className="input w-full" placeholder="+880 1XXX-XXXXXX" />
                        <label className="label text-lg text-gray-500 font-semibold">Pickup Location</label>
                        <input type="text" name="location" value={formData.location} onChange={handleChange} className="input w-full" placeholder="e.g., House 12, Road 5, Dhanmondi, Dhaka" />
                        <label className="label text-lg text-gray-500 font-semibold">Preferred Pickup Date</label>
                        <input type="date" name="date" value={formData.date} onChange={handleChange} className="input w-full" placeholder="e.g., House 12, Road 5, Dhanmondi, Dhaka" />
